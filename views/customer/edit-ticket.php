...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto py-10 px-6">
        ...
        <form action="/update-ticket?id=<?php echo $booking['id'] ?>" method="POST" enctype="multipart/form-data">
            <!-- Users -->
            <div class="mb-4">
                ...
                <input type="text" id="user" name="user" placeholder="Enter your name"
                    ...
                    readonly>
                <input type="hidden" id="user_id" name="user_id" placeholder="Enter your name"
                    value="<?php echo $booking['user_id'] ?>"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
            </div>
            <!-- Events -->
            <div class="mb-4">
